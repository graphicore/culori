		...
		if ((t && typeof t == 'object') || typeof t == 'function')
			for (let n of nn(t))
				!an.call(e, n) &&
					...
					Hr(e, n, {
						get: () => t[n],
						enumerable: !(o = on(t, n)) || o.enumerable
					});
		return e;
	};
var pn = e => ln(Hr({}, '__esModule', { value: !0 }), e);
var Cl = {};
fn(Cl, {
	a98: () => fl,
	average: () => l0,
	...
	clampRgb: () => I0,
	colorsNamed: () => Pt,
	convertA98ToXyz65: () => rt,
	convertCubehelixToRgb: () => Zt,
	convertDlchToLab65: () => ye,
	convertHsiToRgb: () => at,
	convertHslToRgb: () => lt,
	convertHsvToRgb: () => ze,
	convertHwbToRgb: () => mt,
	convertJabToJch: () => dt,
	convertJabToRgb: () => Je,
	convertJabToXyz65: () => qe,
	convertJchToJab: () => ct,
	convertLab65ToDlch: () => Te,
	convertLab65ToRgb: () => re,
	convertLab65ToXyz65: () => $e,
	convertLabToLch: () => A,
	convertLabToRgb: () => je,
	convertLabToXyz50: () => se,
	convertLchToLab: () => I,
	convertLchuvToLuv: () => bt,
	convertLrgbToOklab: () => Ge,
	convertLrgbToRgb: () => j,
	convertLuvToLchuv: () => ht,
	convertLuvToXyz50: () => _e,
	convertOkhslToOklab: () => Ze,
	convertOkhsvToOklab: () => We,
	convertOklabToLrgb: () => U,
	convertOklabToOkhsl: () => Be,
	convertOklabToOkhsv: () => Fe,
	convertOklabToRgb: () => ae,
	convertP3ToXyz65: () => vt,
	convertProphotoToXyz50: () => Tt,
	convertRec2020ToXyz65: () => kt,
	convertRgbToCubehelix: () => Bt,
	convertRgbToHsi: () => ft,
	convertRgbToHsl: () => it,
	convertRgbToHsv: () => ke,
	convertRgbToHwb: () => st,
	...
	convertXyz50ToLuv: () => we,
	convertXyz50ToProphoto: () => yt,
	convertXyz50ToRgb: () => F,
	convertXyz50ToXyz65: () => ur,
	convertXyz65ToA98: () => ot,
	convertXyz65ToJab: () => Ie,
	convertXyz65ToLab65: () => Ce,
	convertXyz65ToP3: () => Mt,
	convertXyz65ToRec2020: () => zt,
	convertXyz65ToRgb: () => Y,
	convertXyz65ToXyz50: () => pr,
	convertYiqToRgb: () => sr,
	converter: () => g,
	cubehelix: () => ll,
	differenceCie76: () => t0,
	differenceCie94: () => r0,
	differenceCiede2000: () => o0,
	differenceCmc: () => n0,
	differenceEuclidean: () => pe,
	differenceHueChroma: () => te,
	differenceHueNaive: () => Ft,
	differenceHueSaturation: () => ee,
	differenceHyab: () => a0,
	differenceKotsarenkoRamos: () => f0,
	displayable: () => Pe,
	dlab: () => il,
	dlch: () => pl,
	easingGamma: () => Tr,
	easingInOutSine: () => en,
	easingMidpoint: () => xr,
	easingSmootherstep: () => V0,
	easingSmoothstep: () => Q0,
	filterBrightness: () => E0,
	filterContrast: () => j0,
	filterDeficiencyDeuter: () => U0,
	filterDeficiencyProt: () => W0,
	filterDeficiencyTrit: () => K0,
	filterGrayscale: () => B0,
	filterHueRotate: () => F0,
	filterInvert: () => Z0,
	filterSaturate: () => G0,
	filterSepia: () => Y0,
	fixupAlpha: () => M,
	fixupHueDecreasing: () => Wo,
	fixupHueIncreasing: () => Fo,
	fixupHueLonger: () => Zo,
	fixupHueShorter: () => w,
	formatCss: () => b0,
	formatHex: () => x0,
	...
	interpolate: () => w0,
	interpolateWith: () => Ho,
	interpolateWithPremultipliedAlpha: () => _0,
	interpolatorLinear: () => u,
	interpolatorPiecewise: () => Yt,
	interpolatorSplineBasis: () => Mr,
	interpolatorSplineBasisClosed: () => yr,
	interpolatorSplineMonotone: () => N0,
	interpolatorSplineMonotone2: () => $0,
	interpolatorSplineMonotoneClosed: () => C0,
	interpolatorSplineNatural: () => S0,
	interpolatorSplineNaturalClosed: () => P0,
	jab: () => cl,
	jch: () => hl,
	lab: () => bl,
	lab65: () => xl,
...
var mn = {
	...
	Pt = mn;
var sn = e => St(Pt[e.toLowerCase()], 6),
	Nt = sn;
var dn = /^#?([0-9a-f]{8}|[0-9a-f]{6}|[0-9a-f]{4}|[0-9a-f]{3})$/i,
	cn = e => {
		let t;
		return (t = e.match(dn)) ? St(parseInt(t[1], 16), t[1].length) : void 0;
	},
	$t = cn;
var O = '([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)',
	Yl = `(?:${O}|none)`,
	...
	et = `(?:${O}%|${O})`,
	hn = `(?:${O}%|${O}|none)`,
	Jo = `(?:${O}(deg|grad|rad|turn)|${O})`,
	Bl = `(?:${O}(deg|grad|rad|turn)|${O}|none)`,
	ie = '\\s*,\\s*';
var Zl = new RegExp('^' + hn + '$');
var bn = new RegExp(
		`^rgba?\\(\\s*${O}${ie}${O}${ie}${O}\\s*(?:,\\s*${et}\\s*)?\\)$`
	),
	xn = new RegExp(
		`^rgba?\\(\\s*${ge}${ie}${ge}${ie}${ge}\\s*(?:,\\s*${et}\\s*)?\\)$`
	),
	gn = e => {
		let t = { mode: 'rgb' },
			r;
...
var K = {},
	...
	yn = e => e,
	T = e => (
		(K[e.mode] = { ...K[e.mode], ...e.toMode }),
		Object.keys(e.fromMode || {}).forEach(t => {
			K[t] || (K[t] = {}), (K[t][e.mode] = e.fromMode[t]);
		}),
		e.ranges || (e.ranges = {}),
		...
		e.channels.forEach(t => {
			...
			typeof e.interpolate[t] == 'function' &&
				...
				e.interpolate[t].fixup || (e.interpolate[t].fixup = yn);
		}),
		(Eo[e.mode] = e),
		(e.parse || []).forEach(t => {
			Xr(t, e.mode);
	...
	Xr = (e, t) => {
		if (typeof e == 'string') {
			...
			At[e] = t;
		} else typeof e == 'function' && ve.indexOf(e) < 0 && ve.push(e);
	},
	jo = e => {
		if (typeof e == 'string') delete At[e];
		else if (typeof e == 'function') {
			let t = ve.indexOf(e);
			t > 0 && ve.splice(t, 1);
		}
	};
var Sr = /[^\x00-\x7F]|[a-zA-Z_]/,
	Tn = /[^\x00-\x7F]|[-\w]/,
	p = {
		Function: 'function',
		Ident: 'ident',
...
var zn = { deg: 1, rad: 180 / Math.PI, grad: 9 / 10, turn: 360 };
function tt(e) {
	let t = '';
	if (
		((e[x] === '-' || e[x] === '+') && (t += e[x++]),
		(t += qt(e)),
		e[x] === '.' && /\d/.test(e[x + 1]) && (t += e[x++] + qt(e)),
		(e[x] === 'e' || e[x] === 'E') &&
			((e[x + 1] === '-' || e[x + 1] === '+') && /\d/.test(e[x + 2])
				? (t += e[x++] + e[x++] + qt(e))
				: /\d/.test(e[x + 1]) && (t += e[x++] + qt(e))),
		Pr(e))
	) {
		let r = Dt(e);
		return r === 'deg' || r === 'rad' || r === 'turn' || r === 'grad'
			? { type: p.Hue, value: t * zn[r] }
			: void 0;
	}
	return e[x] === '%'
...
function Dt(e) {
	let t = '';
	for (; x < e.length && Tn.test(e[x]); ) t += e[x++];
	return t;
}
function kn(e) {
	let t = Dt(e);
...
` ||
		...
		if (o === '-') {
			...
			if (Pr(t)) {
				r.push({ type: p.Ident, value: Dt(t) });
				continue;
			}
			return;
		}
...
var _n = e => {
		...
		let t = Ln(e),
			...
			n = 0,
			a = ve.length;
		for (; n < a; ) if ((o = ve[n++](e, r)) !== void 0) return o;
		return t ? Rn(t) : void 0;
	},
	Ot = _n;
function Hn(e, t) {
...
var V = (e, t, r) => e + r * (t - e),
	Go = (e, t, r) => (r - e) / (t - e),
	jt = (e, t, r, o, n, a) => V(V(e, t, n), V(r, o, n), a),
	Bo = (e, t, r, o, n, a, f, l, i, m, s) =>
		V(jt(e, t, r, o, i, m), jt(n, a, f, l, i, m), s);
var Sn = e => {
		let t = [];
...
var Pn = {
		...
		parse: [Jt, $t, Ct, Nt, Et, 'srgb'],
		serialize: 'srgb',
		interpolate: { r: u, g: u, b: u, alpha: { use: u, fixup: M } },
		gamut: !0
	},
	G = Pn;
var Nr = e => Math.pow(Math.abs(e), 2.19921875) * Math.sign(e),
	Nn = e => {
		let t = Nr(e.r),
			r = Nr(e.g),
			o = Nr(e.b),
	...
	rt = Nn;
var $r = e => Math.pow(Math.abs(e), 0.4547069271758437) * Math.sign(e),
	$n = ({ x: e, y: t, z: r, alpha: o }) => {
		let n = {
			mode: 'a98',
			r: $r(
...
var Cr = e => {
	...
	Cn = ({ r: e, g: t, b: r, alpha: o }) => {
		let n = { mode: 'lrgb', r: Cr(e), g: Cr(t), b: Cr(r) };
		return o !== void 0 && (n.alpha = o), n;
	},
	J = Cn;
var On = e => {
...
var Or = e => {
	...
	An = ({ r: e, g: t, b: r, alpha: o }, n = 'rgb') => {
		let a = { mode: n, r: Or(e), g: Or(t), b: Or(r) };
		return o !== void 0 && (a.alpha = o), a;
	},
	j = An;
var In = ({ x: e, y: t, z: r, alpha: o }) => {
		let n = j({
			r:
...
var qn = {
		...
		parse: ['a98-rgb'],
		serialize: 'a98-rgb',
		fromMode: { rgb: e => ot(E(e)), xyz65: ot },
		toMode: { rgb: e => Y(rt(e)), xyz65: rt }
	},
	Ar = qn;
var Dn = e => ((e = e % 360) < 0 ? e + 360 : e),
	k = Dn;
var Gt = (e, t) =>
		e
			.map((r, o, n) => {
	...
	w = e => Gt(e, t => (Math.abs(t) <= 180 ? t : t - 360 * Math.sign(t))),
	Zo = e =>
		Gt(e, t =>
			Math.abs(t) >= 180 || t === 0 ? t : t - 360 * Math.sign(t)
		),
	Fo = e => Gt(e, t => (t >= 0 ? t : t + 360)),
	Wo = e => Gt(e, t => (t <= 0 ? t : t - 360));
var _ = [-0.14861, 1.78277, -0.29227, -0.90649, 1.97294, 0],
	Uo = Math.PI / 180,
	Ko = 180 / Math.PI;
var Qo = _[3] * _[4],
	Vo = _[1] * _[4],
	e0 = _[1] * _[2] - _[0] * _[3],
	Jn = ({ r: e, g: t, b: r, alpha: o }) => {
		let n = (e0 * r + e * Qo - t * Vo) / (e0 + Qo - Vo),
			a = r - n,
			f = (_[4] * (t - n) - _[2] * a) / _[3],
			l = {
				mode: 'cubehelix',
				...
				s:
					n === 0 || n === 1
						? void 0
						: Math.sqrt(a * a + f * f) / (_[4] * n * (1 - n))
			};
		return (
			l.s && (l.h = Math.atan2(f, a) * Ko - 120),
			o !== void 0 && (l.alpha = o),
			l
		);
	},
	Bt = Jn;
var En = ({ h: e, s: t, l: r, alpha: o }) => {
		let n = { mode: 'rgb' };
		e = (e === void 0 ? 0 : e + 120) * Uo;
	...
	r0 = (e = 1, t = 0.045, r = 0.015) => {
		...
		return (n, a) => {
			let f = o(n),
				...
				v = Math.pow(i - h, 2),
				z = Math.pow(d - y, 2),
				X = Math.pow(m - c, 2) + Math.pow(s - b, 2) - z;
			return Math.sqrt(
				v / Math.pow(e, 2) +
					z / Math.pow(1 + t * d, 2) +
					X / Math.pow(1 + r * d, 2)
	...
	o0 = (e = 1, t = 1, r = 1) => {
		...
		return (n, a) => {
			let f = o(n),
				...
				N = Math.sqrt(X * X + s * s),
				$ = Math.sqrt(S * S + b * b),
				C = Math.abs(X) + Math.abs(s) === 0 ? 0 : Math.atan2(s, X);
			C += (C < 0) * 2 * Math.PI;
			let q = Math.abs(S) + Math.abs(b) === 0 ? 0 : Math.atan2(b, S);
			q += (q < 0) * 2 * Math.PI;
			let he = h - i,
				le = $ - N,
				Z = N * $ === 0 ? 0 : q - C;
			(Z -= (Z > Math.PI) * 2 * Math.PI),
				(Z += (Z < -Math.PI) * 2 * Math.PI);
			let Q = 2 * Math.sqrt(N * $) * Math.sin(Z / 2),
				be = (i + h) / 2,
				xe = (N + $) / 2,
				D;
			N * $ === 0
				? (D = C + q)
				: ((D = (C + q) / 2),
				  (D -= (Math.abs(C - q) > Math.PI) * Math.PI),
				  (D += (D < 0) * 2 * Math.PI));
			let _t = Math.pow(be - 50, 2),
				Ht =
					1 -
					0.17 * Math.cos(D - Math.PI / 6) +
					0.24 * Math.cos(2 * D) +
					0.32 * Math.cos(3 * D + Math.PI / 30) -
					0.2 * Math.cos(4 * D - (63 * Math.PI) / 180),
				Ke = 1 + (0.015 * _t) / Math.sqrt(20 + _t),
				Qe = 1 + 0.045 * xe,
				Ne = 1 + 0.015 * xe * Ht,
				Rr =
					((30 * Math.PI) / 180) *
					Math.exp(
						-1 * Math.pow(((180 / Math.PI) * D - 275) / 25, 2)
					),
				Xt =
					2 *
					Math.sqrt(
	...
	n0 = (e = 1, t = 1) => {
		...
		return (o, n) => {
			...
			let d = r(n),
				...
				v = Math.pow(f - h, 2),
				z = Math.pow(m - y, 2),
				X = Math.pow(l - c, 2) + Math.pow(i - b, 2) - z,
...
var jn = {
	...
	Dr = jn;
var Yn = ({ l: e, a: t, b: r, alpha: o }, n = 'lch') => {
	...
	A = Yn;
var Gn = ({ l: e, c: t, h: r, alpha: o }, n = 'lab') => {
		let a = {
			mode: n,
			l: e,
	...
	I = Gn;
var Wt = Math.pow(29, 3) / Math.pow(3, 3),
	Ut = Math.pow(6, 3) / Math.pow(29, 3);
var R = { X: 0.9642956764295677, Y: 1, Z: 0.8251046025104602 },
	ue = { X: 0.3127 / 0.329, Y: 1, Z: (1 - 0.3127 - 0.329) / 0.329 },
	up = Math.pow(29, 3) / Math.pow(3, 3),
	mp = Math.pow(6, 3) / Math.pow(29, 3);
var Jr = e => (Math.pow(e, 3) > Ut ? Math.pow(e, 3) : (116 * e - 16) / Wt),
	Bn = ({ l: e, a: t, b: r, alpha: o }) => {
		let n = (e + 16) / 116,
			a = t / 500 + n,
			f = n - r / 200,
			l = {
...
var Zn = e => Y($e(e)),
	re = Zn;
var Er = e => (e > Ut ? Math.cbrt(e) : (Wt * e + 16) / 116),
...
var Wn = e => {
	...
	oe = Wn;
var Me = 0.14444444444444443 * Math.PI,
	Oe = Math.cos(Me),
	Ae = Math.sin(Me),
	Kt = 100 / Math.log(139 / 100);
var Un = ({ l: e, c: t, h: r, alpha: o }) => {
		let n = { mode: 'lab65', l: (Math.exp((e * 1) / Kt) - 1) / 0.0039 };
		if (r === void 0) n.a = n.b = 0;
		else {
			let a = (Math.exp(0.0435 * t * 1 * 1) - 1) / 0.075,
				f = a * Math.cos((r / 180) * Math.PI - Me),
				l = a * Math.sin((r / 180) * Math.PI - Me);
			(n.a = f * Oe - (l / 0.83) * Ae), (n.b = f * Ae + (l / 0.83) * Oe);
		}
		return o !== void 0 && (n.alpha = o), n;
	},
	ye = Un;
var Kn = ({ l: e, a: t, b: r, alpha: o }) => {
		let n = t * Oe + r * Ae,
			a = 0.83 * (r * Oe - t * Ae),
			f = Math.sqrt(n * n + a * a),
			l = {
				mode: 'dlch',
				l: (Kt / 1) * Math.log(1 + 0.0039 * e),
				c: Math.log(1 + 0.075 * f) / (0.0435 * 1 * 1)
			};
		return (
			l.c && (l.h = k(((Math.atan2(a, n) + Me) / Math.PI) * 180)),
			o !== void 0 && (l.alpha = o),
			l
		);
	},
	Te = Kn;
var i0 = e => ye(A(e, 'dlch')),
	p0 = e => I(Te(e), 'dlab'),
	Qn = {
		mode: 'dlab',
		parse: ['--din99o-lab'],
		serialize: '--din99o-lab',
		toMode: { lab65: i0, rgb: e => re(i0(e)) },
		fromMode: { lab65: p0, rgb: e => p0(oe(e)) },
		channels: ['l', 'a', 'b', 'alpha'],
		ranges: { l: [0, 100], a: [-40.09, 45.501], b: [-40.469, 44.344] },
		interpolate: { l: u, a: u, b: u, alpha: { use: u, fixup: M } }
	},
	Yr = Qn;
var Vn = {
		mode: 'dlch',
		...
		toMode: { lab65: ye, dlab: e => I(e, 'dlab'), rgb: e => re(ye(e)) },
		fromMode: { lab65: Te, dlab: e => A(e, 'dlch'), rgb: e => Te(oe(e)) },
	...
	Gr = Vn;
function at({ h: e, s: t, i: r, alpha: o }) {
	e = k(e);
...
function ft({ r: e, g: t, b: r, alpha: o }) {
...
var ea = {
	...
	Br = ea;
function lt({ h: e, s: t, l: r, alpha: o }) {
	e = k(e);
...
var ta = (e, t) => {
	...
	u0 = ta;
var ra = new RegExp(
		`^hsla?\\(\\s*${Jo}${ie}${ge}${ie}${ge}\\s*(?:,\\s*${et}\\s*)?\\)$`
	),
	oa = e => {
		let t = e.match(ra);
		if (!t) return;
		...
		return (
			t[3] !== void 0
				? (r.h = +t[3])
				: t[1] !== void 0 && t[2] !== void 0 && (r.h = u0(t[1], t[2])),
...
var fa = {
	...
	ut = fa;
function mt({ h: e, w: t, b: r, alpha: o }) {
	if (t + r > 1) {
		let n = t + r;
		(t /= n), (r /= n);
	}
...
var ia = {
	...
	Zr = ia;
var pa = 0.1593017578125,
	ua = 134.03437499999998,
	ma = 0.8359375,
	sa = 18.8515625,
	da = 18.6875,
	ca = 16295499532821565e-27,
	Fr = e => {
		let t = Math.pow(e / 1e4, pa);
		return Math.pow((ma + sa * t) / (1 + da * t), ua) || 0;
	},
	Wr = e => Math.max(e * 203, 0),
	ha = ({ x: e, y: t, z: r, alpha: o }) => {
		(e = Wr(e)), (t = Wr(t)), (r = Wr(r));
		let n = 1.15 * e - 0.15 * r,
			a = 0.66 * t + 0.34 * e,
			f = Fr(0.41478972 * n + 0.579999 * a + 0.014648 * r),
			l = Fr(-0.20151 * n + 1.120649 * a + 0.0531008 * r),
			i = Fr(-0.0166008 * n + 0.2648 * a + 0.6684799 * r),
			m = (f + l) / 2,
			s = {
				mode: 'jab',
				j: (0.44 * m) / (1 - 0.56 * m) - ca,
	...
	Ie = ha;
var ba = 0.1593017578125,
	xa = 134.03437499999998,
	ga = 0.8359375,
	va = 18.8515625,
	Ma = 18.6875,
	m0 = 16295499532821565e-27,
	Ur = e => {
		let t = Math.pow(e, 1 / xa);
		return 1e4 * Math.pow((ga - t) / (Ma * t - va), 1 / ba) || 0;
	},
	Kr = e => e / 203,
	ya = ({ j: e, a: t, b: r, alpha: o }) => {
		let n = (e + m0) / (0.44 + 0.56 * (e + m0)),
			a = Ur(n + 0.13860504 * t + 0.058047316 * r),
			f = Ur(n - 0.13860504 * t - 0.058047316 * r),
			l = Ur(n - 0.096019242 * t - 0.8118919 * r),
			i = {
				mode: 'xyz65',
				x: Kr(
					1.661373024652174 * a -
				...
				z: Kr(-0.090982811 * a - 0.31272829 * f + 1.5227666 * l)
			};
...
var ka = {
		...
		parse: ['--jzazbz'],
		serialize: '--jzazbz',
		fromMode: { rgb: De, xyz65: Ie },
		toMode: { rgb: Je, xyz65: qe },
		ranges: { j: [0, 0.222], a: [-0.109, 0.129], b: [-0.185, 0.134] },
		interpolate: { j: u, a: u, b: u, alpha: { use: u, fixup: M } }
	},
	Qr = ka;
var La = ({ j: e, a: t, b: r, alpha: o }) => {
...
var wa = {
		...
		parse: ['--jzczhz'],
		serialize: '--jzczhz',
		toMode: { jab: ct, rgb: e => Je(ct(e)) },
		fromMode: { rgb: e => dt(De(e)), jab: dt },
...
var me = Math.pow(29, 3) / Math.pow(3, 3),
	Ee = Math.pow(6, 3) / Math.pow(29, 3);
var eo = e => (Math.pow(e, 3) > Ee ? Math.pow(e, 3) : (116 * e - 16) / me),
	_a = ({ l: e, a: t, b: r, alpha: o }) => {
		let n = (e + 16) / 116,
			a = t / 500 + n,
			f = n - r / 200,
			l = {
...
var Sa = e => {
	...
	W = Sa;
var to = e => (e > Ee ? Math.cbrt(e) : (me * e + 16) / 116),
	Pa = ({ x: e, y: t, z: r, alpha: o }) => {
		let n = to(e / R.X),
			a = to(t / R.Y),
			f = to(r / R.Z),
			l = {
...
var Ca = {
		mode: 'lab',
		toMode: { xyz50: se, rgb: je },
		fromMode: { xyz50: de, rgb: Ye },
		channels: ['l', 'a', 'b', 'alpha'],
...
var Oa = {
		...
		parse: ['--lab-d65'],
		serialize: '--lab-d65',
		toMode: { xyz65: $e, rgb: re },
		fromMode: { xyz65: Ce, rgb: oe },
...
var Ia = {
		mode: 'lch',
		toMode: { lab: I, rgb: e => je(I(e)) },
		fromMode: { rgb: e => A(Ye(e)), lab: A },
		channels: ['l', 'c', 'h', 'alpha'],
...
var qa = {
		...
		parse: ['--lch-d65'],
		serialize: '--lch-d65',
		toMode: { lab65: e => I(e, 'lab65'), rgb: e => re(I(e, 'lab65')) },
		fromMode: { rgb: e => A(oe(e), 'lch65'), lab65: e => A(e, 'lch65') },
		ranges: { l: [0, 100], c: [0, 133.807], h: [0, 360] }
	},
	oo = qa;
var Da = ({ l: e, u: t, v: r, alpha: o }) => {
		let n = Math.sqrt(t * t + r * r),
...
var Ja = ({ l: e, c: t, h: r, alpha: o }) => {
	...
	bt = Ja;
var s0 = (e, t, r) => (4 * e) / (e + 15 * t + 3 * r),
	d0 = (e, t, r) => (9 * t) / (e + 15 * t + 3 * r),
	Ea = s0(R.X, R.Y, R.Z),
	ja = d0(R.X, R.Y, R.Z),
	Ya = e => (e <= Ee ? me * e : 116 * Math.cbrt(e) - 16),
	Ga = ({ x: e, y: t, z: r, alpha: o }) => {
		...
		!isFinite(a) || !isFinite(f)
			? (n = a = f = 0)
			: ((a = 13 * n * (a - Ea)), (f = 13 * n * (f - ja)));
		let l = { mode: 'luv', l: n, u: a, v: f };
		return o !== void 0 && (l.alpha = o), l;
	},
	we = Ga;
var Ba = (e, t, r) => (4 * e) / (e + 15 * t + 3 * r),
	Za = (e, t, r) => (9 * t) / (e + 15 * t + 3 * r),
	Fa = Ba(R.X, R.Y, R.Z),
	Wa = Za(R.X, R.Y, R.Z),
	Ua = ({ l: e, u: t, v: r, alpha: o }) => {
		let n = t / (13 * e) + Fa,
			a = r / (13 * e) + Wa,
			f = R.Y * (e <= 8 ? e / me : Math.pow((e + 16) / 116, 3)),
			l = (f * (9 * n)) / (4 * a),
			i = (f * (12 - 3 * n - 20 * a)) / (4 * a),
...
var Ka = e => ht(we(W(e))),
	...
	Va = {
		mode: 'lchuv',
		toMode: { luv: bt, rgb: Qa },
		fromMode: { rgb: Ka, luv: ht },
		channels: ['l', 'c', 'h', 'alpha'],
		parse: ['--lchuv'],
		serialize: '--lchuv',
...
var tf = {
		mode: 'luv',
		toMode: { xyz50: _e, rgb: e => F(_e(e)) },
		fromMode: { xyz50: we, rgb: e => we(W(e)) },
		channels: ['l', 'u', 'v', 'alpha'],
		parse: ['--luv'],
		serialize: '--luv',
		ranges: { l: [0, 100], u: [-84.936, 175.042], v: [-125.882, 87.243] },
		interpolate: { l: u, u, v: u, alpha: { use: u, fixup: M } }
	},
	fo = tf;
var rf = ({ r: e, g: t, b: r, alpha: o }) => {
		let n = Math.cbrt(
				...
				b = l + i * d;
			{
				let y = n * (1 - f) + f * r,
					...
					D =
						...
						0.2309699292 * le,
					_t =
						4.0767416621 * Z - 3.3077115913 * Q + 0.2309699292 * be,
					Ht = D / (D * D - 0.5 * xe * _t),
					Ke = -xe * Ht,
					Qe =
						-1.2684380046 * N +
					...
					wr =
						...
						1.707614701 * le,
					rn =
						-0.0041960863 * Z - 0.7034186147 * Q + 1.707614701 * be,
					Do = wr / (wr * wr - 0.5 * qo * rn),
					_r = -qo * Do;
				(Ke = Ht >= 0 ? Ke : 1e6),
					(Ve = Xt >= 0 ? Ve : 1e6),
					(_r = Do >= 0 ? _r : 1e6),
					(f += Math.min(Ke, Math.min(Ve, _r)));
			}
		}
	}
	return f;
...
var pf = {
		...
		parse: ['--okhsl'],
		serialize: '--okhsl',
		fromMode: { oklab: Be, rgb: e => Be(ne(e)) },
		toMode: { oklab: Ze, rgb: e => ae(Ze(e)) }
	},
	io = pf;
function Fe(e) {
	let t = Math.sqrt(e.a * e.a + e.b * e.b),
		...
		c = (d * h) / s,
		b = U({ l: h, a: o * c, b: n * c }),
		y = Math.cbrt(1 / Math.max(b.r, b.g, b.b, 0));
	(r = r / y), (t = ((t / y) * xt(r)) / r), (r = xt(r));
	let v = {
		mode: 'okhsv',
...
function We(e) {
	...
	let r = e.h || 0,
		...
		y = He(e.v * m),
		v = (s * y) / m;
	return (t.l = y * b), (t.a = v * o * b), (t.b = v * n * b), t;
}
var uf = {
		...ut,
		mode: 'okhsv',
		...
		parse: ['--okhsv'],
		serialize: '--okhsv',
		fromMode: { oklab: Fe, rgb: e => Fe(ne(e)) },
		toMode: { oklab: We, rgb: e => ae(We(e)) }
	},
	po = uf;
function mf(e, t) {
...
var sf = {
		...Le,
		mode: 'oklab',
		toMode: { lrgb: U, rgb: ae },
		fromMode: { lrgb: Ge, rgb: ne },
...
var cf = {
		...Re,
		mode: 'oklch',
		toMode: { oklab: e => I(e, 'oklab'), rgb: e => ae(I(e, 'oklab')) },
		fromMode: { rgb: e => A(ne(e), 'oklch'), oklab: e => A(e, 'oklch') },
		parse: [ar],
		serialize: e =>
...
var xf = {
		...
		fromMode: { rgb: e => Mt(E(e)), xyz65: Mt },
		toMode: { rgb: e => Y(vt(e)), xyz65: vt }
	},
	so = xf;
var co = e => {
		let t = Math.abs(e);
	...
	gf = ({ x: e, y: t, z: r, alpha: o }) => {
		let n = {
			...
			b: co(e * 0 + t * 0 + 1.2119675456389452 * r)
		};
		return o !== void 0 && (n.alpha = o), n;
	},
	yt = gf;
...
var Mf = {
		...
		fromMode: { xyz50: yt, rgb: e => yt(W(e)) },
		toMode: { xyz50: Tt, rgb: e => F(Tt(e)) }
	},
	bo = Mf;
var c0 = 1.09929682680944,
	yf = 0.018053968510807,
	xo = e => {
		let t = Math.abs(e);
		return t > yf
			? (Math.sign(e) || 1) * (c0 * Math.pow(t, 0.45) - (c0 - 1))
			: 4.5 * e;
	},
	Tf = ({ x: e, y: t, z: r, alpha: o }) => {
		let n = {
			mode: 'rec2020',
			r: xo(
	...
	zt = Tf;
var h0 = 1.09929682680944,
	zf = 0.018053968510807,
	go = e => {
		let t = Math.abs(e);
		return t < zf * 4.5
			? e / 4.5
			: (Math.sign(e) || 1) * Math.pow((t + h0 - 1) / h0, 1 / 0.45);
	},
	kf = e => {
		let t = go(e.r),
			r = go(e.g),
...
var Lf = {
		...G,
		mode: 'rec2020',
		fromMode: { xyz65: zt, rgb: e => zt(E(e)) },
		toMode: { xyz65: kt, rgb: e => Y(kt(e)) },
		parse: ['rec2020'],
		serialize: 'rec2020'
	},
	vo = Lf;
var fe = 0.0037930732552754493,
	fr = Math.cbrt(fe);
var Mo = e => Math.cbrt(e) - fr,
	Rf = e => {
		let { r: t, g: r, b: o, alpha: n } = J(e),
			a = Mo(0.3 * t + 0.622 * r + 0.078 * o + fe),
			f = Mo(0.23 * t + 0.692 * r + 0.078 * o + fe),
			l = Mo(
	...
	lr = Rf;
var yo = e => Math.pow(e + fr, 3),
	wf = ({ x: e, y: t, b: r, alpha: o }) => {
		let n = yo(e + t) - fe,
			a = yo(t - e) - fe,
			f = yo(r + t) - fe,
			l = j({
...
var _f = {
		...
		interpolate: { x: u, y: u, b: u, alpha: { use: u, fixup: M } }
	},
	To = _f;
var Hf = {
		mode: 'xyz50',
		...
		serialize: 'xyz-d50',
		toMode: { rgb: F, lab: de },
		fromMode: { rgb: W, lab: se },
		channels: ['x', 'y', 'z', 'alpha'],
		ranges: { x: [0, 0.964], y: [0, 0.999], z: [0, 0.825] },
		interpolate: { x: u, y: u, z: u, alpha: { use: u, fixup: M } }
	},
	zo = Hf;
var Xf = e => {
...
var Pf = {
		mode: 'xyz65',
		toMode: { rgb: Y, xyz50: pr },
		fromMode: { rgb: E, xyz50: ur },
...
var Cf = {
		...
		interpolate: { y: u, i: u, q: u, alpha: { use: u, fixup: M } }
	},
	Lo = Cf;
var Of = (e, t) => Math.round(e * (t = Math.pow(10, t))) / t,
	Af =
		(e = 4) =>
		t =>
			typeof t == 'number' ? Of(t, e) : t,
	dr = Af;
var Lt = dr(2),
	Rt = e => Math.max(0, Math.min(1, e)),
	Xe = e => Math.round(Rt(e) * 255),
	cr = e => {
		if (e === void 0) return;
		let t = Xe(e.r),
			r = Xe(e.g),
	...
	Ro = e => {
		if (e === void 0) return;
		let t = Xe(e.alpha !== void 0 ? e.alpha : 1);
		return cr(e) + (256 | t).toString(16).slice(1);
	},
	wo = e => {
		if (e === void 0) return;
		let t = e.r !== void 0 ? Xe(e.r) : 'none',
			r = e.g !== void 0 ? Xe(e.g) : 'none',
			o = e.b !== void 0 ? Xe(e.b) : 'none';
		return e.alpha === void 0 || e.alpha === 1
			? `rgb(${t}, ${r}, ${o})`
			: `rgba(${t}, ${r}, ${o}, ${Lt(Rt(e.alpha))})`;
	},
	_o = e => {
		if (e === void 0) return;
		let t = Lt(e.h || 0),
			r = e.s !== void 0 ? Lt(Rt(e.s) * 100) + '%' : 'none',
			o = e.l !== void 0 ? Lt(Rt(e.l) * 100) + '%' : 'none';
		return e.alpha === void 0 || e.alpha === 1
			? `hsl(${t}, ${r}, ${o})`
			: `hsla(${t}, ${r}, ${o}, ${Lt(Rt(e.alpha))})`;
	},
	b0 = e => {
		let t = P(e);
		if (!t) return;
...
var If = {
	...
	qf = (e, t = 'normal', r = 'rgb') => {
		let o = typeof t == 'function' ? t : If[t],
			n = g(r),
			a = L(r).channels;
		return e
			.map(l => {
...
var Df = ([e, t]) => e + Math.random() * (t - e),
	...
	Ef = (e = 'rgb', t = {}) => {
		...
		return r.channels.reduce(
			(n, a) => (
				(o.alpha || a !== 'alpha') && (n[a] = Df(o[a] || r.ranges[a])),
				n
			),
			{ mode: e }
		);
...
var Yf =
	...
	xr = Yf;
var gr = e => typeof e == 'function',
	Se = e => e && typeof e == 'object',
	L0 = e => typeof e == 'number',
	R0 = (e, t = 'rgb', r, o) => {
		let n = L(t),
			a = g(t),
			f = [],
		...
		let m = n.channels.reduce((h, c) => {
			let b;
			return (
				Se(r) && Se(r[c]) && r[c].fixup
					? (b = r[c].fixup)
					: Se(n.interpolate[c]) && n.interpolate[c].fixup
		...
		if (o) {
			let h = f.map((c, b) =>
				n.channels.reduce((y, v) => ((y[v] = m[v][b]), y), { mode: t })
			);
			m = n.channels.reduce(
				(c, b) => (
					(c[b] = h.map(y => {
		...
		let s = n.channels.reduce((h, c) => {
				...
				return (
					gr(r)
						...
						: gr(n.interpolate[c])
						? (b = n.interpolate[c])
						: Se(n.interpolate[c]) && (b = n.interpolate[c].use),
					(h[c] = b(m[c])),
					h
				);
			}, {}),
		...
		return h => {
			...
			let b = l[c - 1],
				...
				v = (h - b) / y,
				z = i[c] || i[0];
			z !== void 0 && (L0(z) && (z = xr((z - b) / y)), (v = z(v)));
			let X = (c - 1 + v) / d;
	...
	w0 = (e, t = 'rgb', r) => R0(e, t, r),
	Ho =
		(e, t) =>
		(r, o = 'rgb', n) => {
			let a = t ? ce(t, o) : void 0,
				f = R0(r, o, n, e);
			return a ? l => a(f(l)) : f;
		},
	_0 = Ho(hr, br);
...
var Ue = Math.sign,
	...
	N0 = e => {
		...
		let t = e.length - 1,
			[r, , o] = So(e);
		return (o[0] = r[0]), (o[t] = r[t - 1]), Po(e, o, r);
	},
	$0 = e => {
		if (e.length < 3) return u(e);
		let t = e.length - 1,
	...
	C0 = e => {
		...
		let a = (e[0] - e[t]) * t,
			f = a;
		return (
			(n[0] = (Ue(a) + Ue(r[0])) * Xo(B(a), B(r[0]), 0.5 * B(o[0]))),
			(n[t] =
				(Ue(r[t - 1]) + Ue(f)) * Xo(B(r[t - 1]), B(f), 0.5 * B(o[t]))),
			Po(e, n, r)
		);
	};
...
function I0(e) {
	return (e = P(e)), e === void 0 || Pe(e) ? e : g(e.mode)($o(No(e)));
}
function Co(e = 'rgb') {
	let { gamut: t } = L(e);
	if (!t) return a => P(a);
...
function q0(e, t = 'lch') {
	if (((e = P(e)), e === void 0 || Pe(e))) return e;
	let r = g(e.mode);
	e = g(t)(e);
	let o = { ...e, c: 0 };
	if (!Pe(o)) return r($o(No(o)));
	let n = 0,
		a = e.c,
		f = L(t).ranges.c,
		...
		i;
	for (; a - n > l; )
		(o.c = n + (a - n) * 0.5), Pe(o) ? ((i = o.c), (n = o.c)) : (a = o.c);
	return r(Pe(o) ? o : { ...o, c: i });
}
function D0(e = 'rgb', t = 'oklch', r = pe('oklch'), o = 0.02) {
	let n = g(e);
...
var Zf = (e, t = pe(), r = o => o) => {
	...
	J0 = Zf;
var Oo = e => Math.max(e, 0),
	Ao = e => Math.max(Math.min(e, 1), 0),
	Ff = (e, t, r) => (e === void 0 || t === void 0 ? void 0 : e + r * (t - e)),
	Wf = e => {
		let t = 1 - Ao(e);
		return [
			0.393 + 0.607 * t,
	...
	j0 = (e = 1, t = 'rgb') => {
		let r = Oo(e);
		return ce(wt(r, (1 - r) / 2), t, !0);
	},
	Y0 = (e = 1, t = 'rgb') => kr(Wf(e), t, !0),
	G0 = (e = 1, t = 'rgb') => kr(Uf(e), t, !0),
	B0 = (e = 1, t = 'rgb') => kr(Kf(e), t, !0),
	Z0 = (e = 1, t = 'rgb') => {
		let r = Ao(e);
		return ce((o, n) => (n === 'alpha' ? o : Ff(r, 1 - r, o)), t, !0);
	},
	F0 = (e = 0, t = 'rgb') => kr(Qf(e), t, !0);
var Vf = g('rgb'),
	el = [
		[1, 0, -0, 0, 1, 0, -0, -0, 1],
		[
...
var ol = e => e * e * (3 - 2 * e),
	Q0 = ol;
var nl = e => e * e * e * (e * (e * 6 - 15) + 10),
	V0 = nl;
var al = e => (1 - Math.cos(e * Math.PI)) / 2,
	en = al;
function Lr(e) {
	let t = g('lrgb')(e);
